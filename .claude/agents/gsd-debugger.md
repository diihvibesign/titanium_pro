...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /home/guest/Área de trabalho/titanium_pro/.claude
                  → checks /home/guest/Área de trabalho/titanium_pro/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /home/guest/Área de trabalho/titanium_pro/.claude/get-shit-done
                  → writes to /home/guest/Área de trabalho/titanium_pro/.claude/get-shit-done/hooks/
...
@/home/guest/Área de trabalho/titanium_pro/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @/home/guest/Área de trabalho/titanium_pro/.claude/get-shit-done/references/common-bug-patterns.md
...
```bash
INIT=$(node "/home/guest/Área de trabalho/titanium_pro/.claude/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "/home/guest/Área de trabalho/titanium_pro/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/home/guest/Área de trabalho/titanium_pro/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```

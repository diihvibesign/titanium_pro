...
```bash
node "/home/guest/Área de trabalho/titanium_pro/.claude/get-shit-done/bin/gsd-tools.cjs" websearch "your query" --limit 10
```
...
@/home/guest/Área de trabalho/titanium_pro/.claude/get-shit-done/references/thinking-models-research.md
...
```bash
node "/home/guest/Área de trabalho/titanium_pro/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): research phase domain" --files "$PHASE_DIR/$PADDED_PHASE-RESEARCH.md"
```

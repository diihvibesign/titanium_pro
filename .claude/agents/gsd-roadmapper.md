...
Reference full template: `/home/guest/Área de trabalho/titanium_pro/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/guest/Área de trabalho/titanium_pro/.claude/get-shit-done/templates/state.md`.

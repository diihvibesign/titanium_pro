...
<reference>
@/home/guest/Área de trabalho/titanium_pro/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/home/guest/Área de trabalho/titanium_pro/.claude/get-shit-done/references/user-profiling.md` to load:

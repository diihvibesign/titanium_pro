...
Use template from `/home/guest/Área de trabalho/titanium_pro/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/home/guest/Área de trabalho/titanium_pro/.claude/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "/home/guest/Área de trabalho/titanium_pro/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```

...
- Usage: Reference from command with `@/home/guest/Área de trabalho/titanium_pro/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /home/guest/Área de trabalho/titanium_pro/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /home/guest/Área de trabalho/titanium_pro/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

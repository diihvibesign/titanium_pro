...
- **Global scope**: `/home/guest/Área de trabalho/titanium_pro/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/guest/Área de trabalho/titanium_pro/.claude/notes/`)
...
2. Glob `/home/guest/Área de trabalho/titanium_pro/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/home/guest/Área de trabalho/titanium_pro/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/guest/Área de trabalho/titanium_pro/.claude/notes/` — works in any directory

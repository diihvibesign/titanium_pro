...
<execution_context>
@/home/guest/Área de trabalho/titanium_pro/.claude/get-shit-done/workflows/session-report.md
</execution_context>

<process>
Execute the session-report workflow from @/home/guest/Área de trabalho/titanium_pro/.claude/get-shit-done/workflows/session-report.md end-to-end.
</process>

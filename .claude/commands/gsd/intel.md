...
Intel system is disabled. To activate:
  ...
  node /home/guest/Área de trabalho/titanium_pro/.claude/get-shit-done/bin/gsd-tools.cjs config-set intel.enabled true
...
```bash
node /home/guest/Área de trabalho/titanium_pro/.claude/get-shit-done/bin/gsd-tools.cjs intel query <term>
```
...
```bash
node /home/guest/Área de trabalho/titanium_pro/.claude/get-shit-done/bin/gsd-tools.cjs intel status
```
...
```bash
node /home/guest/Área de trabalho/titanium_pro/.claude/get-shit-done/bin/gsd-tools.cjs intel diff
```
...
Project root: ${CWD}
gsd-tools path: /home/guest/Área de trabalho/titanium_pro/.claude/get-shit-done/bin/gsd-tools.cjs

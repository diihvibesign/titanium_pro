...
function DefaultMarkerIcon() {
  return (
    <div className="relative h-4 w-4 rounded-full border-2 border-[#FE1616] bg-primary shadow-lg" />
  );
}
...
function MarkerPopup({
  ...
  return createPortal(
    <div
      className={cn(
        "relative rounded-md border bg-[#0D0D12] text-white p-3 shadow-md animate-in fade-in-0 zoom-in-95",
        className
      )}
    >
      {closeButton && (
...
function MarkerTooltip({
  ...
  return createPortal(
    <div
      className={cn(
        "rounded-md bg-white px-2 py-1 text-xs text-black shadow-md animate-in fade-in-0 zoom-in-95",
        className
      )}
    >
      {children}
...
function ControlGroup({ children }: { children: React.ReactNode }) {
  return (
    <div className="flex flex-col rounded-md border border-white/10 bg-[#0a0a0f] shadow-sm overflow-hidden [&>button:not(:last-child)]:border-b [&>button:not(:last-child)]:border-white/10 text-white">
      {children}
    </div>
  );
}
...
function ControlButton({
  ...
  return (
    <button
      ...
      type="button"
      className={cn(
        "flex items-center justify-center size-8 hover:bg-white/10 transition-colors",
...
function MapPopup({
  ...
  return createPortal(
    <div
      className={cn(
        "relative rounded-md border bg-[#0D0D12] p-3 text-white shadow-md animate-in fade-in-0 zoom-in-95",
        className
      )}
    >
      {closeButton && (

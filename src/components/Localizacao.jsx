...
// Lazy load the Map component itself for double isolation
const Map = lazy(() => import('./ui/map').then(module => ({ default: module.Map })));
        ...
        <div className="relative z-10 w-full max-w-4xl rounded-[40px] border border-white/5 overflow-hidden shadow-[0_0_50px_rgba(254,22,22,0.05)] h-[450px] mb-12 flex justify-center bg-[#111115] group/map">
          ...
          {isMapActive ? (
            ...
            <div className="relative w-full h-full flex items-center justify-center group">
              {/* Static Placeholder Stylized */}
              <div className="absolute inset-0 bg-[#0a0a0c] opacity-50">
                <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,_transparent_0%,_#0a0a0c_70%)]"></div>
                {/* Decorative lines to simulate a map path */}
